...
import { TrendingUp, ShieldCheck, Mail, Lock, Loader2, AlertCircle, CheckCircle2 } from 'lucide-react'
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-3 h-4 w-4 text-muted-foreground outline-none" />
                <Input 
                  id="email"
                  type="email" 
